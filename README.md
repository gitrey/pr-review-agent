...
An autonomous [Managed Agent](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/managed-agents) designed to automatically review GitHub
Pull Requests for code quality, type contract compliance, dependencies, and
compilation correctness.

## 🚀 Overview

This repository contains Python scripts to configure, run, and manage a
specialized AI agent on Google Cloud Agent Platform.

The agent runs in a secure, remote code-execution sandbox to fetch PR branches,
perform builds, run tests, and generate detailed engineering reviews.
...
Trigger a code review. You can customize the prompt/PR URL in `invoke-agent.py`.
The review runs asynchronously in the cloud sandbox, outputs live
progress/actions to your console, and automatically saves a file:
